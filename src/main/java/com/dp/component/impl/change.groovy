...
bizAdapter.inputMethods."$methodName" = { String input ->
...
bizAdapter.inputMethods.funCustimze = { item, elementValue, funName ->
    if (!funName) {
        return elementValue
    }
...
bizAdapter.inputMethods.childResolve = { itemPre, allSourceParams, item, mpNamePath, HashMap map, Boolean sub ->
